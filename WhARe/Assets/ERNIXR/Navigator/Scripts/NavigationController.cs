...
namespace ERNIXR.Navigation
{
    ...
    /// <summary>
    /// Controller for Navigaton example.
    /// </summary>
    public class NavigationController : MonoBehaviour
    {
        ...
        /// </summary>
        public List<AugmentedPathVisualizer> prefabs = new List<AugmentedPathVisualizer>();
        ...
        private Dictionary<int, AugmentedPathVisualizer> m_Visualizers
            = new Dictionary<int, AugmentedPathVisualizer>();
        ...
        public void Update()
        {
            ...
            {
                AugmentedPathVisualizer visualizer = null;
                ...
                if (image.TrackingState == TrackingState.Tracking && visualizer == null)
                {
                    ...
                    visualizer = (AugmentedPathVisualizer)Instantiate(prefabs[image.DatabaseIndex], anchor.transform);
